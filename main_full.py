...
class classifier:
    ...
    def train(self,X,Y):
        ...
        if self.TRAIN_WITH_AUGMENTATION:
            self.save_model_joblib("models/mask-classifiers/model_augmented.pkl", grid_search.best_estimator_)
            self.save_model_pickle("models/mask-classifiers/model_augmented.pkl", grid_search.best_estimator_)
            self.save_model_onnx("models/mask-classifiers/model_augmented.onnx", grid_search.best_estimator_)
        else:
            self.save_model_joblib("models/mask-classifiers/model.pkl", grid_search.best_estimator_)
            self.save_model_pickle("models/mask-classifiers/model.pkl", grid_search.best_estimator_)
            self.save_model_onnx("models/mask-classifiers/model.onnx", grid_search.best_estimator_)
        return grid_search.best_estimator_

    def report(self,X,Y):
        model = self.load_model_pickle("models/mask-classifiers/model.pkl")
    ...
    def test_pickle(self,X):
        ...
        model = self.load_model_joblib("models/mask-classifiers/model.pkl")
        model = self.load_model_pickle("models/mask-classifiers/model.pkl")
    ...
    def test_onnx(self,X):
        ...
        model_sess = self.load_model_onnx("models/mask-classifiers/model.onnx")
